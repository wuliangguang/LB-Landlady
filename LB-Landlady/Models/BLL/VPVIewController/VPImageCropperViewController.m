...
- (void)initControlBtn
{
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 50.0f, kScreenWidth/2, 50)];
    cancelBtn.backgroundColor = [UIColor darkGrayColor];
    cancelBtn.titleLabel.textColor = [UIColor whiteColor];
    [cancelBtn setTitle:@"取消" forState:UIControlStateNormal];
    [cancelBtn setBackgroundImage:[UIImage imageNamed:@"denglukuang1.png"] forState:UIControlStateNormal];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width/2, self.view.frame.size.height - 50.0f, kScreenWidth/2, 50)];
    confirmBtn.backgroundColor = [UIColor darkGrayColor];
    confirmBtn.titleLabel.textColor = [UIColor whiteColor];
    [confirmBtn setTitle:@"确定" forState:UIControlStateNormal];
    [confirmBtn setBackgroundImage:[UIImage imageNamed:@"denglukuang1.png"] forState:UIControlStateNormal];
